...
<!-- Display Status-->
<?php
if(!isset($_SESSION['error-msg']) && !isset($_SESSION['status'])){
    echo "<br><br><br>";
}
...
{ ?>
    <section class="container mt-5">
        ...
        <h3 class="text-teal text-center mb-5">Congratulations! Your <?php echo ucwords($_SESSION['id-type']) ?> has been successfully approved</h3>
        ...
        <ul>
            ...
            <li><strong>Contact us: </strong>For further assistance, please contact us through:<br>
                <ul>
                    <li><strong>Email: </strong>governmentapplication@gmail.com</li>
